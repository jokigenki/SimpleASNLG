...
package simpleasnlg.features
{
	...
	public final class ClauseStatus extends StringEnum
	{	
		private static var _locked:Boolean = false;
		
		public function ClauseStatus(key:String)
		{
			super(key);
		 ...
		 */
		public static const MATRIX:ClauseStatus				= new ClauseStatus("matrix");
		
		/**
		 * The subordinate clauses are contained within a higher clause.
		 */
		public static const SUBORDINATE:ClauseStatus		= new ClauseStatus("subordinate");
