...
package simpleasnlg.aggregation
{
	 ...
	 * and cue phrase of an {@link simpleasnlg.phrasespec.SPhraseSpec}.
	 * </P>
	 * 
	 * <P>
	...
	public class ForwardConjunctionReductionRule extends AggregationRule {
		 ...
		 */
		public function ForwardConjunctionReductionRule()
		{
			super();
		}
		 ...
		 * e2.getCategory == {@link simpleasnlg.framework.PhraseCategory#CLAUSE}) and
		...
		override public function applyElements(previous:NLGElement, next:NLGElement):NLGElement
		{
			...
			if (previous.getCategory() == PhraseCategory.CLAUSE
				...
				var leftPeriphery:Array = PhraseChecker.leftPeriphery(previous, next);
	
				var len:int = leftPeriphery.length;
				for (var i:int = 0; i < len; i++)
				{
					var pair:PhraseSet = leftPeriphery[i];
