...
package simpleasnlg.framework
{
	...
	public class NLGModule
	{
		...
		protected var lexicon:Lexicon = null;
		 ...
		 *         new element.
		 */
		public function realise(element:NLGElement):NLGElement
		{
			throw new Error ("NLGModule.realise must be overridden");
		}
		 ...
		 */
		public function realiseList(elements:Array):Array
		{
			throw new Error ("NLGModule.realiseList must be overridden");
		}
