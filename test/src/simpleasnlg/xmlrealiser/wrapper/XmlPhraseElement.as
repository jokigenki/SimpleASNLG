...
package simpleasnlg.xmlrealiser.wrapper
{
	    ...
	    extends XmlNLGElement
	{
	    ...
	    public List<XmlNLGElement> getFrontMod() {
	        if (frontMod == null) {
	            frontMod = new Array<XmlNLGElement>();
	        }
	    ...
	    public List<XmlNLGElement> getPreMod() {
	        if (preMod == null) {
	            preMod = new Array<XmlNLGElement>();
	        }
	        return this.preMod;
	    }
	     ...
	     *     
	     */
	    public function setHead(XmlWordElement value) {
	        this.head = value;
	    }
	    ...
	    public List<XmlNLGElement> getPostMod() {
	        if (postMod == null) {
	            postMod = new Array<XmlNLGElement>();
	        }
	        return this.postMod;
	    }
	     ...
	     *     
	     */
	    public function setDiscourseFunction(XmlDiscourseFunction value) {
