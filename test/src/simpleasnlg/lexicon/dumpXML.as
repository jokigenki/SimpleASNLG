...
package simpleasnlg.lexicon
{
	...
	public class dumpXML {
		...
		// filenames
		public static const DB_FILENAME:String = "E:\\NIHDB\\lexAccess2009";  // DB location
		public static const WORDLIST_FILENAME:String  = "E:\\NIHDB\\wordlist.csv";  // word list
		public static const XML_FILENAME:String  = "E:\\NIHDB\\default-lexicon.xml";  // word list
		...
		{
			var lex:Lexicon = new NIHDBLexicon(DB_FILENAME);
			try
			{
